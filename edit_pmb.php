...
$id = $_GET['id_pmb'];
$ambilData = mysqli_query($koneksi, "SELECT * FROM tb_pmb WHERE id='$id'");
...
<body id="page-top">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-sm-12 pt-5 text-center m-auto">
                                <div class="card" style="border: 0; border-radius: 20px;">
                                    <div class="card-body">
                                        <h2 style="font-weight: 700;">Edit PMB</h2>
    ...
    if (isset($_POST['edit'])) {
        ...
        if ($sources != "") {
            ...
            $update = mysqli_query($koneksi, "UPDATE tb_pmb SET
            judul='$judul',
            deskripsi='$deskripsi',
            foto='$nama_foto'
            WHERE id='$id'
