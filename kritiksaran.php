                            ...
                            <table class="table table-bordered text-center" style="display: block; margin-top: 5px; width: auto; height: auto; overflow: auto;">
                                <thead class="bg-dark text-white text-center">
                                    <tr>
                                        ...
                                        <th scope="col" width="300px">Kritik & Saran</th>
                                ...
                                <tbody>
                                    <?php
                                    include "koneksi.php";
                                    $query = "SELECT * FROM tb_kritiksaran";
                                    ...
                                    ?>
                                        <tr>
                                            <th scope="row"><?= $no++; ?></th>
                                            <td width="300px"><?= $row['nama']; ?></td>
                                            <td width="300px"><?= $row['email']; ?></td>
                                            <td width="300px"><?= $row['kritiksaran']; ?></td>
                                            <td width="150px" class="text-center">
                                                <a href="hapus.php?id_ks=<?= $row['id']; ?>" onclick="return confirm('Apakah anda yakin?');"><span class="badge bg-danger">Hapus</span></a>
                                            </td>
                                        </tr>
                                    <?php
                                    }
