...
<body id="page-top">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-sm-12 pt-5 text-center m-auto">
                                <div class="card" style="border: 0; border-radius: 20px;">
                                    <div class="card-body">
                                        <h2 style="font-weight: 700;">Tambah News</h2>
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <br>
                                            <div class="form-group">
                                                <button type="submit" name="tambah_news" class="btn btn-primary" style="width:100%; border-radius: 50px;">Tambah</button>
                                            </div>
                                            <br>
                                        </form>
                                    </div>
    ...
    if (isset($_POST['tambah_news'])) {
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO tb_news VALUES(
        NULL,
        '$judul',
        '$deskripsi',
        '$nama_foto',now())");
        ...
        if ($insert) {
            echo "<script>alert('Selamat Data Berhasil Tersimpan !');document.location='news.php'</script>";
        } else {
            echo 'Gagal Upload !';
        }
    }
