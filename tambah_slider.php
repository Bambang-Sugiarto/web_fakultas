...
<body id="page-top">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-sm-12 pt-5 text-center m-auto">
                                <div class="card" style="border: 0; border-radius: 20px;">
                                    <div class="card-body">
                                        <h2 style="font-weight: 700;">Tambah Slider</h2>
                                        <p>Silahkan Isi Pada Form Berikut</p>
                                        <br>
                                        <form action="" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <input type="file" class="form-control" name="gambar" style="border-radius: 50px;">
                                            </div>
                                            <br>
                                            <div class="form-group">
                                                <button type="submit" name="tambah_slider" class="btn btn-primary" style="width:100%; border-radius: 50px;">Tambah</button>
                                            </div>
                                            <br>
                                        </form>
                                    </div>
    ...
    if (isset($_POST['tambah_slider'])) {
        ...
        move_uploaded_file($sources, $folder . $nama_gambar);
